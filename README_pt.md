# criar e operar uma API da Cloudflare
...
<p align="center">
  <a href="https://labex.io/pt/courses/project-build-and-operate-a-cloudflare-api">
    <img src="https://course-cover.labex.io/project-build-and-operate-a-cloudflare-api.png?lang=pt" alt="criar e operar uma API da Cloudflare">
  </a>
</p>

Aplique suas habilidades com o Cloudflare Workers em três desafios independentes: lançar um portal de suporte, corrigir o compartilhamento de cache entre clientes e recuperar uma versão que falhou com um tratamento testado do serviço upstream. Use dados sintéticos e verifique a limpeza dos recursos.

[Iniciar curso no LabEx](https://labex.io/pt/courses/project-build-and-operate-a-cloudflare-api)

## Exercícios

|   Índice | Nome                                | Dificuldade   | Prática                                                                                                                                                        |
|----------|-------------------------------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Lançamento do Portal de Suporte     | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/challenge-support-portal-launch?course=project-build-and-operate-a-cloudflare-api'>Iniciar Desafio</a>       |
|        2 | Mistura de cache entre clientes     | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/challenge-cross-customer-cache-mix-up?course=project-build-and-operate-a-cloudflare-api'>Iniciar Desafio</a> |
|        3 | Recuperação de uma versão com falha | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/challenge-failed-release-recovery?course=project-build-and-operate-a-cloudflare-api'>Iniciar Desafio</a>     |
